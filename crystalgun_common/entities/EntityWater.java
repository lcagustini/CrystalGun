...
public class EntityWater extends Entity implements IProjectile
{
    ...
    public EntityWater(World par1World, EntityLiving par2EntityLiving, ArrayList effect, ArrayList effectextra, int redColor, int greenColor, int blueColor)
    {
        super(par1World);
        effects = effect;

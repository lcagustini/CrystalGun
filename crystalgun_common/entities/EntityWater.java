...
public class EntityWater extends Entity implements IProjectile
{
    ...
    public void onUpdate()
    {
        ...
        {
        	CrystalGunParticleHandler.spawnParticle("Water", this.posX, this.posY, this.posZ, this.motionX - 0.4546F, this.motionY - 0.4546F, this.motionZ - 0.4546F, red, green, blue);
        }

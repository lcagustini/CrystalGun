...
public class EntityFire extends Entity implements IProjectile
{
    ...
    public EntityFire(World par1World, EntityLiving par2EntityLiving, ArrayList effect, ArrayList effectextra, int redColor, int greenColor, int blueColor)
    {
        super(par1World);
        effects = effect;
    ...
    public void onUpdate()
    {
        ...
        {
        	CrystalGunParticleHandler.spawnParticle("Fire", this.posX, this.posY, this.posZ, this.motionX - 0.4546F, this.motionY - 0.4546F, this.motionZ - 0.4546F, red, green, blue);
        }
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
    	...
    	for(int k = 0; k < 5; k++)
    	{
    		...
    		CrystalGunParticleHandler.spawnParticle("Fire", this.posX, this.posY, this.posZ, 0, 0, 0, red, green, blue);
    		this.worldObj.spawnParticle("smoke", this.posX, this.posY, this.posZ, 0, 0, 0);
    	}
    }

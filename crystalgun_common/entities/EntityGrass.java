...
public class EntityGrass extends Entity implements IProjectile
{
    ...
    public EntityGrass(World par1World)
    {
        super(par1World);
    ...
    public EntityGrass(World par1World, EntityLiving par2EntityLiving, ArrayList effect, ArrayList effectextra, int redColor, int greenColor, int blueColor)
    {
        super(par1World);
        effects = effect;
    ...
    public EntityGrass(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
    	...
    	for(int k = 0; k < 5; k++)
    	{
    		...
    		CrystalGunParticleHandler.spawnParticle("Grass", this.posX, this.posY, this.posZ, 0, 0, 0, red, green, blue);
    		this.worldObj.spawnParticle("smoke", this.posX, this.posY, this.posZ, 0, 0, 0);
    	}
    }

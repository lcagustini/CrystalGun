...
public class ParticleFire extends EntityFX
{
	...
	public ParticleFire(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, int redColor, int greenColor, int blueColor)
	{

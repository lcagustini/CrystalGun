...
public class EntityLife extends Entity implements IProjectile
{
    ...
    public EntityLife(World par1World)
    {
        super(par1World);
    ...
    public EntityLife(World par1World, EntityLiving par2EntityLiving, ArrayList effect, ArrayList effectextra, int redColor, int greenColor, int blueColor)
    {
        super(par1World);
        effects = effect;
    ...
    public EntityLife(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
    ...
    public void onUpdate()
    {
        ...
        {
        	CrystalGunParticleHandler.spawnParticle("Life", this.posX, this.posY, this.posZ, this.motionX - 0.4546F, this.motionY - 0.4546F, this.motionZ - 0.4546F, red, green, blue);
        }
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
    	...
    	for(int k = 0; k < 5; k++)
    	{
    		...
    		CrystalGunParticleHandler.spawnParticle("Life", this.posX, this.posY, this.posZ, 0, 0, 0, red, green, blue);
    		this.worldObj.spawnParticle("smoke", this.posX, this.posY, this.posZ, 0, 0, 0);
    	}
    }

...
public class ItemCrystalGunGrass extends Item implements ICrystalGun
{
	...
	public ItemCrystalGunGrass(int par1)
	{
		super(par1);
	...
	public ItemCrystalGunGrass setName(String string)
	{
		name = string;
		return this;
	}
    ...
    public ItemCrystalGunGrass setEffect(String effect, int damage, int k, int l, int j)
    {
		effects.add(effect);
		if(effect == "Potion")
		{
    ...
    public ItemCrystalGunGrass setColor(int redColor, int greenColor, int blueColor)
    {
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
    	...
    	if(!world.isRemote)
    	{
    		EntityGrass entity = new EntityGrass(world, entityplayer, effects, effectsextra, red, green, blue);

...
public class ItemCrystalGunLife extends Item implements ICrystalGun
{
	...
	public ItemCrystalGunLife(int par1)
	{
		super(par1);
	...
	public ItemCrystalGunLife setName(String string)
	{
		name = string;
		return this;
	}
    ...
    public ItemCrystalGunLife setEffect(String effect, int damage, int k, int l, int j)
    {
		effects.add(effect);
		if(effect == "Potion")
		{
    ...
    public ItemCrystalGunLife setColor(int redColor, int greenColor, int blueColor)
    {
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
    	...
    	if(!world.isRemote)
    	{
    		EntityLife entity = new EntityLife(world, entityplayer, effects, effectsextra, red, green, blue);

...
public class ItemCrystalGunFire extends Item implements ICrystalGun
{
	...
	public ItemCrystalGunFire(int par1)
	{
		super(par1);
	...
	public ItemCrystalGunFire setName(String string)
	{
		name = string;
		return this;
	}
    ...
    public ItemCrystalGunFire setEffect(String effect, int damage, int k, int l, int j)
    {
		effects.add(effect);
		if(effect == "Potion")
		{
    ...
    public ItemCrystalGunFire setColor(int redColor, int greenColor, int blueColor)
    {
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
    	...
    	if(!world.isRemote)
    	{
    		EntityFire entity = new EntityFire(world, entityplayer, effects, effectsextra, red, green, blue);

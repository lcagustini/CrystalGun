...
public class ItemCrystalGunHealing extends Item implements ICrystalGun
{
	...
	public ItemCrystalGunHealing(int par1)
	{
		super(par1);
	...
	public ItemCrystalGunHealing setName(String string)
	{
		name = string;
		return this;
	}
    ...
    public ItemCrystalGunHealing setEffect(String effect, int damage, int k, int l, int j)
    {
		effects.add(effect);
		if(effect == "Potion")
		{
    ...
    public ItemCrystalGunHealing setColor(int redColor, int greenColor, int blueColor)
    {
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
    	...
    	if(!world.isRemote)
    	{
    		EntityHealing entity = new EntityHealing(world, entityplayer, effects, effectsextra, red, green, blue);

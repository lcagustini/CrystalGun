...
public class ItemCrystalGunIce extends Item implements ICrystalGun
{
	...
	public ItemCrystalGunIce(int par1)
	{
		super(par1);
	...
	public ItemCrystalGunIce setName(String string)
	{
		name = string;
		return this;
	}
    ...
    public ItemCrystalGunIce setEffect(String effect, int damage, int k, int l, int j)
    {
		effects.add(effect);
		if(effect == "Potion")
		{
    ...
    public ItemCrystalGunIce setColor(int redColor, int greenColor, int blueColor)
    {
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
    	...
    	if(!world.isRemote)
    	{
    		EntityIce entity = new EntityIce(world, entityplayer, effects, effectsextra, red, green, blue);
